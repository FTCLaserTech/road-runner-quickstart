...
public class SpecimensAuto5 extends LinearOpMode
{
    ...
    public void runOpMode() throws InterruptedException
    {
        ...
        Pose2d toSubmursible2 = new Pose2d(-61, 36, Math.toRadians(270));
        Pose2d toSubmursible3 = new Pose2d(-65, 36, Math.toRadians(270));
        Pose2d toSubmursible4 = new Pose2d(-67, 36, Math.toRadians(270));
        Pose2d toSubmursible5 = new Pose2d(-69, 36, Math.toRadians(270));
