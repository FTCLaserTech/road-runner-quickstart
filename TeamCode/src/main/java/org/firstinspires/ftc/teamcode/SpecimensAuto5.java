...
public class SpecimensAuto5 extends LinearOpMode
{
    ...
    public void runOpMode() throws InterruptedException
    {
        ...
        Pose2d sweep3 = new Pose2d(70, 5, Math.toRadians(270));
        Pose2d sweep3a = new Pose2d(65, 12, Math.toRadians(270));
        ...
        Pose2d toSubmursible2 = new Pose2d(-61, 37, Math.toRadians(270));
        Pose2d toSubmursible3 = new Pose2d(-65, 37, Math.toRadians(270));
        Pose2d toSubmursible4 = new Pose2d(-66, 37, Math.toRadians(270));
        Pose2d toSubmursible5 = new Pose2d(-68, 37, Math.toRadians(270));
