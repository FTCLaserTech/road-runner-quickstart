...
public class SpecimensAutoPush3PinPoint extends LinearOpMode
{
    ...
    public void runOpMode() throws InterruptedException
    {
        ...
        Pose2d slideOver1 = new Pose2d(32,53,Math.toRadians(270));
        Pose2d sweep = new Pose2d(32,14,Math.toRadians(270));
        Pose2d backTo1 = new Pose2d(32,50,Math.toRadians(270));
        Pose2d slideOver2 = new Pose2d(41,50,Math.toRadians(270));
        Pose2d sweep2 = new Pose2d(41,14,Math.toRadians(270));
        Pose2d backTo2 = new Pose2d(41,50,Math.toRadians(270));
        Pose2d slideOver3 = new Pose2d(48,50,Math.toRadians(270));
